 ...
 */
public class WxOkHttp {

    private static final String TAG = "OkHttpUtils";

    private static WxOkHttp mInstance;
    ...
    private synchronized static WxOkHttp getInstance() {
        if (mInstance == null) {
            mInstance = new WxOkHttp();
        }
        return mInstance;
    }
...
//                    LogUtils.e(TAG, "convert json failure", e);
    ...
    public static void post(String url, final ResultCallback callback, String xml) {
        getInstance().postRequest(url, callback, xml);
    }
    /**
